...
// Distribution
// Distribution integration (Spotify, DistroKid)

export default function GapDistribution() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-distribution', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Distribution</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Distribution integration (Spotify, DistroKid)</p>
