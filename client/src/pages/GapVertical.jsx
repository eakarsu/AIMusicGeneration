...
// Vertical
// Vertical producer packs (lo-fi, EDM, hip-hop) with mastering automation
...
export default function GapVertical() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Vertical producer packs (lo-fi, EDM, hip-hop) with mastering automation</p>
