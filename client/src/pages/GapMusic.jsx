...
// Music
// Music theory lesson surface

export default function GapMusic() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-music', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Music</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Music theory lesson surface</p>
