...
// Audio
// Audio file upload / recording capability

export default function GapAudio() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-audio', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Audio</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Audio file upload / recording capability</p>
