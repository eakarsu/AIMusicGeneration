...
// Artist
// Artist collaboration platform with revenue sharing and distribution

export default function GapArtist() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-artist', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Artist</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Artist collaboration platform with revenue sharing and distribution</p>
